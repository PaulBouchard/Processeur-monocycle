...
add wave -radix binary /processeur_tb/irq0
add wave -radix binary /processeur_tb/irq1
add wave -radix binary /processeur_tb/P/irq_end
add wave -radix hexadecimal /processeur_tb/P/Afficheur
add wave /processeur_tb/P/DI/instr_courante
add wave -radix hexadecimal /processeur_tb/P/vicpc
add wave -radix decimal /processeur_tb/P/UT/BR/Banc
